...
#set0 = affine_set<()[s0, s1, s2, s3] : (s0 - 1 >= 0, s1 - 1 >= 0, s2 - 1 >= 0, s3 - 1 >= 0)>
#set1 = affine_set<(d0)[s0, s1] : (-d0 + (s0 - 1) floordiv 32 >= 0, -d0 + (s1 - 1) floordiv 32 >= 0)>
#set2 = affine_set<(d0)[s0, s1] : (-d0 + (s0 - 1) floordiv 32 >= 0, d0 - s1 ceildiv 32 >= 0)>
          ...
          affine.if #set1(%arg12)[%1, %3] {
            affine.for %arg13 = #map2(%arg11) to min #map3(%arg11)[%0] {
              affine.for %arg14 = #map2(%arg12) to min #map4(%arg12)[%1, %3] {
                call @S2(%arg10, %arg13, %arg14, %arg5) : (memref<?x2400xf64>, index, index, f64) -> ()
            ...
            affine.for %arg14 = #map2(%arg11) to min #map3(%arg11)[%0] {
              affine.for %arg15 = #map2(%arg13) to min #map3(%arg13)[%2] {
                affine.for %arg16 = #map2(%arg12) to min #map3(%arg12)[%1] {
                  call @S1(%arg6, %arg14, %arg16, %arg8, %arg15, %arg4, %arg7) : (memref<?x1800xf64>, index, index, memref<?x1800xf64>, index, f64, memref<?x2200xf64>) -> ()
                }
              }
            }
          }
            ...
            affine.for %arg14 = #map2(%arg11) to min #map3(%arg11)[%0] {
              affine.for %arg15 = #map2(%arg12) to min #map3(%arg12)[%1] {
                affine.for %arg16 = #map2(%arg13) to min #map3(%arg13)[%3] {
                  call @S3(%arg10, %arg14, %arg16, %arg9, %arg15, %arg6) : (memref<?x2400xf64>, index, index, memref<?x2400xf64>, index, memref<?x1800xf64>) -> ()
                }
              }
            }
          }
