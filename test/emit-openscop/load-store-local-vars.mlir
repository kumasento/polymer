...
// CHECK: DOMAIN
// CHECK: 4 5 1 0 1 1
// CHECK: # e/i| i1 | l1 | P1 |  1  
// CHECK:    1    1    0    0    0    ## i1 >= 0
// CHECK:    1    0   -2    1    0    ## -2*l1+P1 >= 0
// CHECK:    1    0    2   -1    1    ## 2*l1-P1+1 >= 0
// CHECK:    1   -1    1    0   -1    ## -i1+l1-1 >= 0
// CHECK: # ----------------------------------------------  1.2 Scattering
// CHECK: SCATTERING
// CHECK: 3 8 3 1 1 1
// CHECK: # e/i| c1   c2   c3 | i1 | l1 | P1 |  1  
